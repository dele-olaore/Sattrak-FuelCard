 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://zenithbank.com/mtn/fleet", wsdlLocation = "https://webservices.zenithbank.com/MtnFleetService/Service.asmx?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://zenithbank.com/mtn/fleet", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://webservices.zenithbank.com/MtnFleetService/Service.asmx?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://zenithbank.com/mtn/fleet", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://zenithbank.com/mtn/fleet", "ServiceSoap"), ServiceSoap.class, features);
    }
    ...
    public ServiceSoap getServiceSoap12() {
        return super.getPort(new QName("http://zenithbank.com/mtn/fleet", "ServiceSoap12"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://zenithbank.com/mtn/fleet", "ServiceSoap12"), ServiceSoap.class, features);
    }
