...
public class ServiceLocator extends org.apache.axis.client.Service implements com.zenithbank.mtn.fleet.Service {
    ...
    private java.lang.String ServiceSoap_address = "https://webservicestest.zenithbank.com/MtnFleetService/Service.asmx";
    ...
    public com.zenithbank.mtn.fleet.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.zenithbank.mtn.fleet.ServiceSoapStub _stub = new com.zenithbank.mtn.fleet.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.zenithbank.mtn.fleet.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.zenithbank.mtn.fleet.ServiceSoapStub _stub = new com.zenithbank.mtn.fleet.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://zenithbank.com/mtn/fleet", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://zenithbank.com/mtn/fleet", "ServiceSoap"));
        }
