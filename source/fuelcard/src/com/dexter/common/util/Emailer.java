...
{	
     ...
     * @param fname The filename of the attached document.
     * @param mimeType The mime type of the attached document.
     * */
    public static synchronized String sendEmail(String from, String[] to, String subject,
            String body, byte[] data, String fname, String mimeType)
    {
        ...
        try
        {
            ...
            DataSource source = new ByteArrayDataSource(data, mimeType); // application/vnd.ms-excel, application/pdf
